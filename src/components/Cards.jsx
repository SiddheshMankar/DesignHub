...
function Cards() {
  return (
    <div className='cards w-full  flex justify-center gap-5  py-20'>
      <div className='w-[40vw] h-[25vw] bg-[#004D43] py-20 mt-10 rounded-xl   '>
      <div className=' flex justify-center py-20 '>
      <svg width="100" height="50" viewBox="0 0 72 30" fill="none" className='text-[#CDEA68] ' xmlns="http://www.w3.org/2000/svg">
      ...
      <div className='text-[#CDEA68] px-10 py-10 pb-10'>
       <button className='border-[2px] rounded-xl  border-[#CDEA68]  w-[8vw]  '>©2019-2022</button>

      </div>


      </div>
      <div className=' w-[20vw] h-[25vw] bg-[#212121] py-20 mt-10 rounded-xl'>
      <div className=' flex justify-center py-20 '>
      <img src="https://ochi.design/wp-content/uploads/2022/04/logo002.svg" alt="" />
      </div>
      <div className='px-10 py-7 pb-10'>
      <button className='border-[2px] rounded-xl  w-[10vw]  '>RATING 5.0 CLUTCH</button>
      </div>
      </div>
      ...
      <button className='border-[2px] rounded-xl  w-[17vw] text-sm  '>BUSSINESS BOOTCAMP ALLUMINAI</button>
      </div>
      </div>
