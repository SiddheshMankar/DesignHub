...
function Footer() {
  return (
    <div className='w-full h-full flex  bg-zinc-900 p-20 '>
        <div className='w-1/2  h-full flex flex-col justify-between '>
          <div className='heading   '>
          <h1 className='text-[6vw] uppercase font-semibold leading-none mb-10'>Eye-</h1>
            <h1 className='text-[6vw] uppercase  font-semibold leading-none mb-10'>Opening</h1>
...
<svg width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='w-1/2  h-full flex flex-col justify-between '>
          <div className='heading   '>
          <h1 className='text-[6vw] uppercase font-semibold leading-none mb-10'>Presentations</h1>
          <p>S:</p>
          <a href="" className="block underline">Facebook</a>
          <a href="" className="block underline"> Instagram </a>
            <a href="" className="block underline">Whatsapp</a>
            <a href="" className="block underline">Linkedin</a>

            <p className='block mt-20'>L:</p>
            <p className='block'>202-1965 W 4th Ave</p>
            <p className='block'>Vancouver, Canada</p>
            <br />
            <br />
            <p className='block'>30 Chukarina St</p>
            <p className='block'>Lviv, Ukraine</p>
