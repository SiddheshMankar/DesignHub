...
function LandingPage() {
  ...
  return (
    <div data-scroll data-scroll-section data-scroll-speed='-.3' className='w-full h-screen bg-zinc-900 pt-1 '>
            ...
            {["We Create ","Eye Opening ","Presentations"].map((item,index) => {
                return (
                    ...
                    <div className="masker  ">
                        ...
                        {index===1 && (
                        <motion.div initial={{width:0}} animate={{width:"9vw"}} transition={{ease:[0.76,0,0.24,1],duration:1}}  className=' mr-4 w-[8vw] rounded-md h-[5vw] top-[1vw] relative bg-black'>
                        <span className='flex items-center py-3 px-5'>
                        ...
                        <h1 className=' flex items-center text-[7vw] leading-[6vw] uppercase'>
                            {item}
                        </h1>
                        </div>
                    </div>
        ...
        <div className='border-t-2 border-zinc-100 mt-20 flex justify-between items-center py-5 px-20 '>
        {["For Public and Private Companies","from the first pitch to Ipo"].map((item,index) => (
    <p className=" text-xl font-light tracking-tight leading-none ">{item}</p>
))}
<div className='start flex items-center gap-2'>
<div className='px-5 py-2 border-[2px] border-zinc-500 rounded-full font-light text-lg capitalize '>
Starts the Project
</div>
<div className='w-11 h-11 border-[2px] border-zinc-500 rounded-full  flex items-center justify-center '>
